...
public sealed class RunInTickVoid : INotifyCompletion
{
    ...
    ///     <see cref="Core.QueueWorkItem(Action)" />.
    /// </summary>
    ...
    ///     Different from <see cref="Task{TResult}" />, if the operation is not completed, this instance will return the
    ///     default value of <typeparamref name="T" /> instead of blocking the thread until the task is completed. However, if
